...
workflow.add_node("create_evaluation_run", create_evaluation_run)
...
workflow.add_node("finalize_evaluation_run", finalize_evaluation_run)
...
workflow.add_edge("fetch_pr_info", "create_evaluation_run")
workflow.add_edge("create_evaluation_run", "analyze_jira_ticket_number")
workflow.add_edge("analyze_jira_ticket_number", "policy_rule_analysis")
workflow.add_edge("policy_rule_analysis", "finalize_evaluation_run")
workflow.add_edge("finalize_evaluation_run", "post_pr_comment")
